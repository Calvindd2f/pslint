...
#You can include a SuggestedCorrections property of type IEnumerable<CorrectionExtent>.
{
...
#https://github.com/PowerShell/PSScriptAnalyzer/tree/master/Tests/Engine/CommunityAnalyzerRules